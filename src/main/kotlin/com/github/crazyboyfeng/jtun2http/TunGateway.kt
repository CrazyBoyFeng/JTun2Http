...
abstract class TunGateway @Throws(TunInterfaceInvalidException::class) constructor(private val tunInterface: FileDescriptor, private val remoteProxy: SocketAddress): Runnable{
